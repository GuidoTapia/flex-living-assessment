...
async function main() {
  ...
  const reviews = await Promise.all([
    prisma.review.upsert({
      where: { externalId_source: { externalId: 'review-001', source: 'hostaway' } },
      update: {},
      create: {
        source: 'hostaway',
    ...
    prisma.review.upsert({
      where: { externalId_source: { externalId: 'review-002', source: 'hostaway' } },
      update: {},
      create: {
        source: 'hostaway',
    ...
    prisma.review.upsert({
      where: { externalId_source: { externalId: 'review-003', source: 'hostaway' } },
      update: {},
      create: {
        source: 'hostaway',
    ...
    prisma.review.upsert({
      where: { externalId_source: { externalId: 'review-004', source: 'google' } },
      update: {},
      create: {
        source: 'google',
